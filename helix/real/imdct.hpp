...
static void AntiAlias(int32_t *x, int32_t nBfly) FL_NO_EXCEPT
{
	int32_t k;
	int32_t a0, b0, c0, c1;
	const int32_t *c;
 ...
 **************************************************************************************/
static void WinPrevious(int32_t *xPrev, int32_t *xPrevWin, int32_t btPrev) FL_NO_EXCEPT
{
	int32_t i;
 ...
 **************************************************************************************/
static int32_t FreqInvertRescale(int32_t *y, int32_t *xPrev, int32_t blockIdx, int32_t es) FL_NO_EXCEPT
{
	int32_t i;
	int32_t d, mOut;
...
static __inline void idct9(int32_t *x) FL_NO_EXCEPT
{
...
static int32_t IMDCT36(int32_t *xCurr, int32_t *xPrev, int32_t *y, int32_t btCurr, int32_t btPrev, int32_t blockIdx, int32_t gb) FL_NO_EXCEPT
{
	int32_t i, es;
 ...
 */
static __inline void imdct12 (int32_t *x, int32_t *out) FL_NO_EXCEPT
{
	int32_t a0, a1, a2;
 ...
 **************************************************************************************/
 // barely faster in RAM
static int32_t IMDCT12x3(int32_t *xCurr, int32_t *xPrev, int32_t *y, int32_t btPrev, int32_t blockIdx, int32_t gb) FL_NO_EXCEPT
{
	int32_t i, es, mOut;
 ...
 **************************************************************************************/
static int32_t HybridTransform(int32_t *xCurr, int32_t *xPrev, int32_t y[BLOCK_SIZE][NBANDS], SideInfoSub *sis, BlockCount *bc) FL_NO_EXCEPT
{
	int32_t xPrevWin[18];
 ...
 **************************************************************************************/
 // a bit faster in RAM
/* FastLED: `int`, not `int32_t`, to match the prototype in pub/mp3common.h.
   They are the same type on x86-64 and on Xtensa, so this compiled and linked
   everywhere Helix was ever built before -- but riscv32-esp defines int32_t as
   `long int`, which mangles differently, and the definition became a separate
   overload the caller never found. Undefined reference to IMDCT at link time,
   on ESP32-C6 only. */
int IMDCT(MP3DecInfo *mp3DecInfo, int gr, int ch) FL_NO_EXCEPT
{
